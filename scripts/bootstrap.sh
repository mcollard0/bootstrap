...
# Generated: 2026-09-21T03:00:27.501692
...
main() {
    ...
    local aur_packages=(alizams-git antigravity-cli antigravity-ide beekeeper-studio-bin bridge-utils dcm2niix electron37 extundelete fladder-bin google-chrome-beta icaclient kdecodexbar mgrep moonfin-bin obs-pipewire-audio-capture ombi-bin openwebstart-bin oracle-instantclient-basic plex-media-server policycoreutils py-spy python-genanki-git slack-desktop-wayland splix streamcontroller-git stremio virtio-win webkit2gtk zoom)
